...
// Returns wether this key state signals if the key being held down
...
// The left most bit represents wether the key is currently toggled.
//
// All keys will return a toggled on value, but this functionality is most useful for keys like CapsLock.
